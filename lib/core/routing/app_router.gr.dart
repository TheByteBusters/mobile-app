...
abstract class _$AppRouter extends RootStackRouter {
  ...
  final Map<String, PageFactory> pagesMap = {
    ...
    IncubatorsRoute.name: (routeData) {
      return AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const IncubatorsScreen(),
      );
    },
    ...
    SearchRequestRoute.name: (routeData) {
      return AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const SearchRequestScreen(),
      );
    },
...
/// generated route for
/// [IncubatorsScreen]
class IncubatorsRoute extends PageRouteInfo<void> {
  const IncubatorsRoute({List<PageRouteInfo>? children})
      : super(
          IncubatorsRoute.name,
          initialChildren: children,
        );

  static const String name = 'IncubatorsRoute';
...
class MonitoringRoute extends PageRouteInfo<void> {
  const MonitoringRoute({List<PageRouteInfo>? children})
      : super(
...
/// generated route for
/// [SearchRequestScreen]
class SearchRequestRoute extends PageRouteInfo<void> {
  const SearchRequestRoute({List<PageRouteInfo>? children})
      : super(
          SearchRequestRoute.name,
          initialChildren: children,
        );

  static const String name = 'SearchRequestRoute';
